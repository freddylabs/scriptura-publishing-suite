        ...
        try:
            ...
            if content_length > MAX_UPLOAD_BYTES + MAX_MULTIPART_OVERHEAD:
                ...
                self.send_json_response({
                    "success": False,
                    "error": "File is over 2 GB. Please upload a smaller recording."
                }, status=413)
                return
...
if __name__ == "__main__":
    ...
    print(f"Studio running at http://localhost:{PORT} (uploads up to 2 GB, deleted when you finish or after 4 hours)")
    try:
        httpd.serve_forever()
